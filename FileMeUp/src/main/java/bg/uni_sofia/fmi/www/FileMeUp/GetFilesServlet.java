...
public class GetFilesServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		out.println("<html><head><meta charset=\"UTF-8\"><title>All files</title><style>"
				...
				+ "</style></head><body>");
		out.println("<table><tr><th>File Name</th><th>Download</th></tr>");
		...
		out.println("<form action=\"/\"><input type=\"submit\" value=\"Go back to upload\" id=\"fixedButton\" /></form></body></html>");
